...
# The version info for the product you're documenting, acts as replacement for
...
# "<product> v<release> documentation".
#html_title = None
...
texinfo_documents = [
  ('index', 'bootstrap-datepicker', u'bootstrap-datepicker Documentation',
   u'eternicode', 'bootstrap-datepicker', 'One line description of product.',
   'Miscellaneous'),
]
